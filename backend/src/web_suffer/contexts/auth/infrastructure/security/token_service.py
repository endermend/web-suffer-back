...
from web_suffer.config import JWT
...
from web_suffer.contexts.auth.domain.value_objects import TokenPair
...
class TokenService(ITokenService):
    ...
    def get_user_id_by_access_token(self, access_token: str) -> UserID | None:
        """
