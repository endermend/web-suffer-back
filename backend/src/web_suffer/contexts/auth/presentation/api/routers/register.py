...
from web_suffer.contexts.auth.application.dto.register_user import (
    RegisterUserInputDTO,
)
from web_suffer.contexts.auth.application.use_cases import RegisterUserUseCase
from web_suffer.contexts.auth.presentation.api.cookie_service import CookieService
from web_suffer.contexts.auth.presentation.api.schemas.register import (
    UserRegisterRequest,
